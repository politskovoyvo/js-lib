...
//     return this.reduce(
//         (a, b) => ((predicate ? predicate(a) : a) >= (predicate ? predicate(b) : b) ? a : b),
//         {},
//     );
// };
//
// // @ts-ignore
// Array.prototype.selectMany = function<T>(predicate?: (value: T) => unknown): unknown {
//     // @ts-ignore
...
//         a.filter((c) => (predicate ? !b.some((d) => predicate(d, c)) : b.includes(c))),
//     );
// };
//
// Array.prototype.unionWith = function<T>(
//     array: T[],
//     predicate?: (left: T, right: T) => boolean,
// ): Array<T> {
//     return [this, array].reduce((a, b) =>
...
// };
//
// Array.prototype.sortSearch = function<T>(predicate?: (value: T) => unknown, search?: any): Array<T> {
//     return this.sort((a, b) => {
//         const ap =
//             ((predicate ? predicate(a) : a).toLowerCase().indexOf(search.toLowerCase()) === 0
//                 ? '\x00'
//                 : '') + (predicate ? predicate(a) : a);
//         const bp =
//             ((predicate ? predicate(b) : b).toLowerCase().indexOf(search.toLowerCase()) === 0
//                 ? '\x00'
...
// };
//
// Array.prototype.leftJoin = function<T>(array: Array<T>, primaryKey?: any, foreignKey?: any): Array<T> {
//     const arr = [];
//     primaryKey = primaryKey || ((a: any) => a);
//     foreignKey = foreignKey || ((b: any) => b);
//
